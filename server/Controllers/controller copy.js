...
//     async.waterfall([
//         function (callback) {
//             callback(null, req.body.email, req.body.password)
//         },
//         function (email, password, callback) {
//             // console.log(email, password);
//             var checkAdmin = AdminSch.findOne({
//                 $and: [{
//                     email: email
//                 },
//                 {
...
//                     res.status(406).json({ data: "failed" })
//                 } else {
...
//             const jwttoken = generateToken(req, res, login);
